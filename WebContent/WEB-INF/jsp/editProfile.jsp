...
<div style="background-color: #EEF2F4;">
	...
	<br>
	<div id="padding-left">
	<form:form action="/RentCarSpring/user/saveEditProfile" method="POST" modelAttribute="user">
	<table>
	...
	<form:input path="status" type="hidden"/>
		<tr>
			<td>username </td>	
			<td><input style="width:120px;" value="${user.username}" disabled/></td>
		</tr>
		<tr>
			<td>password </td>
		...
		<tr>
			<td>status </td>
			<td><input style="width:120px;" value="${user.status}" disabled/></td>
		</tr>
		<tr>
			...
			<form action="/RentCarSpring/rentcar/maker">
			<td>
